...
::::::: {.column width="50%"}
<br>
<img src="Assets/Slides_Assets/toyexample.png"/>
:::::::
...
::: fragment
-   Building a ranking algorithm(i.e. [XGBoost](https://cran.r-project.org/web/packages/xgboost/xgboost.pdf)) using hand-crafted features to rank the likeliest recipient at a frame - 51.6 $\pm$ 0.8% top-1 accuracy
...
|------------------------|---------------------------------------------------------------------------------------------|
| **Recipient Features** | - *Distance (x, y, magnitude)* <br> - *Speed Differences (x, y, magnitude)* <br> - *Orientation Differences* <br> - *Speed Vector Differences* <br> - Receiver Position <br> - First Down Indicator |
...
::: {.column width="34%"}
<br><br>
<img src="Assets/Slides_Assets/moore_throw_rankings.png"/>
:::
:::::::::
...
::::::: {.column width="50%"}
<br><br>
<img src="Assets/Slides_Assets/MostPredictable.png"/>
:::::::

::: {.column width="50%"}
<br><br>
<img src="Assets/Slides_Assets/MostUnPredictable.png"/>
:::
:::::::::
## Potential Optimization with More Conventional Passes
::: {style="text-align: center;"}
<img src="Assets/Slides_Assets/QBClustering.png"/>
:::
...
- Acknowledgements: Karim Kassam, Quang Nguyen, CMU Statistics

- Code: [https://github.com/zachbtw/Zhou-Pipping-CMSA](https://github.com/zachbtw/Zhou-Pipping-CMSA)

- Contact Us:
  - Lou Zhou: [lou-zhou.github.io](https://lou-zhou.github.io)
  - Zachary Pipping: placeholder

## Appendix A - Code

[https://github.com/zachbtw/Zhou-Pipping-CMSA](https://github.com/zachbtw/Zhou-Pipping-CMSA)
...
<img src="Assets/Slides_Assets/vip_plot_notitle.png"/>
